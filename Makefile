...
SRCS=$(COMMON_SRCS) $(MULTI_IBLT_SRCS) $(TABULATION_SRCS) $(BASIC_FIELD_SRCS) $(FINGERPRINT_SRCS) $(FILE_SYNC_SRCS) $(STRATA_SRCS) $(DIR_SYNC_SRCS)
OBJS=$(SRCS:%.cpp=obj/%.o)
...
PROGRAMS=$(MULTI_IBLT) $(TABULATION) $(BASIC_FIELD) $(FINGERPRINT) $(SYNC) $(STRATA) $(DIR_SYNC)

.PHONY: default all tabulation multi_iblt field fingerprint sync strata dir_sync
default: all
all: $(PROGRAMS)
